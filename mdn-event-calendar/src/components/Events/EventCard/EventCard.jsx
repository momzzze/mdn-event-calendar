  ...
  return (
    <div
      ...
      <div className="h-full w-2/12 flex justify-center items-center bg-white">
        <span
          className="tracking-wider text-gray-600 bg-gray-200 px-2 text-sm rounded leading-loose mx-2 font-semibold cursor-pointer"
          onClick={() => onDeleteEvent(eventId)} // Извикваме функцията с идентификатора на събитието
        >
          Delete
        </span>
      </div>
